# -*- coding: utf-8 -*-
"""
Gerador Completo e Especializado da Base de Conhecimento PT-BR para todos os 191 repositórios.
Elimina 100% de frases genéricas, fallbacks repetitivos e termos em inglês.
Cada repositório recebe uma descrição cirúrgica, casos de uso reais e Dica Pro exclusiva.
"""
...
def build_all_191_entries():
    with open(ALL_STARS_FILE, "r", encoding="utf-8") as f:
        stars = json.load(f)

    # Base de conhecimento individualizada e cirúrgica para TODOS os repositórios
    # Chave: full_name do repositório
    K = {}

    # 001 - marinabudarina/chimes
    K["marinabudarina/chimes"] = {
    ...
    # 002 - akitaonrails/distrobox-gaming
    K["akitaonrails/distrobox-gaming"] = {
    ...
    # 004 - yoanbernabeu/grepai
    K["yoanbernabeu/grepai"] = {
    ...
    # 007 - SpacehuhnTech/WiFiDuck
    K["SpacehuhnTech/WiFiDuck"] = {
    ...
    # 008 - cifertech/RF-Clown
    K["cifertech/RF-Clown"] = {
    ...
    # 009 - VoltAgent/awesome-claude-code-subagents
    K["VoltAgent/awesome-claude-code-subagents"] = {
    ...
    # 010 - Donchitos/Claude-Code-Game-Studios
    K["Donchitos/Claude-Code-Game-Studios"] = {
    ...
    # 011 - codeaashu/claude-code
    K["codeaashu/claude-code"] = {
    ...
    # 012 - ultraworkers/claw-code
    K["ultraworkers/claw-code"] = {
    ...
    # 014 - elie222/botdirectory.ai
    K["elie222/botdirectory.ai"] = {
    ...
    # 017 - assafelovic/gpt-researcher
    K["assafelovic/gpt-researcher"] = {
    ...
    # 019 - danny-avila/LibreChat
    K["danny-avila/LibreChat"] = {
    ...
    # 020 - openinterpreter/openinterpreter
    K["openinterpreter/openinterpreter"] = {
    ...
    # 021 - DeusData/codebase-memory-mcp
    K["DeusData/codebase-memory-mcp"] = {
    ...
    # 022 - sickn33/agentic-awesome-skills
    K["sickn33/agentic-awesome-skills"] = {
    ...
    # 024 - VoltAgent/awesome-design-md
    K["VoltAgent/awesome-design-md"] = {
    ...
    # 025 - appsmithorg/appsmith
    K["appsmithorg/appsmith"] = {
    ...
    # 027 - documenso/documenso
    K["documenso/documenso"] = {
    ...
    # 031 - dani-garcia/vaultwarden
    K["dani-garcia/vaultwarden"] = {
    ...
    # 032 - louislam/uptime-kuma
    K["louislam/uptime-kuma"] = {
    ...
    # 033 - Zimbra-Community/shared-mailbox-toolkit
    K["Zimbra-Community/shared-mailbox-toolkit"] = {
    ...
    # 036 - Leonxlnx/taste-skill
    K["Leonxlnx/taste-skill"] = {
    ...
    # 037 - calesthio/OpenMontage
    K["calesthio/OpenMontage"] = {
    ...
    # 038 - Panniantong/Agent-Reach
    K["Panniantong/Agent-Reach"] = {
    ...
    # 039 - cathrynlavery/diagram-design
    K["cathrynlavery/diagram-design"] = {
    ...
    # 040 - lidge-jun/opencodex
    K["lidge-jun/opencodex"] = {
    ...
    # 041 - Tabbit-Browser/dsh-plugin
    K["Tabbit-Browser/dsh-plugin"] = {
    ...
    # 043 - lwthiker/curl-impersonate
    K["lwthiker/curl-impersonate"] = {
    ...
    # 045 - browser-use/browser-use
    K["browser-use/browser-use"] = {
    ...
    # 046 - firecrawl/firecrawl
    K["firecrawl/firecrawl"] = {
    ...
    # 047 - microsoft/markitdown
    K["microsoft/markitdown"] = {
    ...
    # 048 - unclecode/crawl4ai
    K["unclecode/crawl4ai"] = {
    ...
    # 049 - MrCl0wnLab/BR-EvilPortal-HTML-Files
    K["MrCl0wnLab/BR-EvilPortal-HTML-Files"] = {
    ...
    # 053 - ZhuLinsen/daily_stock_analysis
    K["ZhuLinsen/daily_stock_analysis"] = {
    ...
    # 054 - addyosmani/agent-skills
    K["addyosmani/agent-skills"] = {
    ...
    # 056 - PrimeIntellect-ai/prime-agent
    K["PrimeIntellect-ai/prime-agent"] = {
    ...
    # 057 - promovaweb/specsfy
    K["promovaweb/specsfy"] = {
    ...
    # 058 - yashab-cyber/opendroid
    K["yashab-cyber/opendroid"] = {
    ...
    # 059 - itsfatduck/optimizerDuck
    K["itsfatduck/optimizerDuck"] = {
    ...
    # 060 - microsoft/ai-agents-for-beginners
    K["microsoft/ai-agents-for-beginners"] = {
    ...
    # 061 - abundantbeing/hermes-browser-extension
    K["abundantbeing/hermes-browser-extension"] = {
    ...
    # 062 - vitali87/code-graph-rag
    K["vitali87/code-graph-rag"] = {
    ...
    # 067 - Stirling-Tools/Stirling-PDF
    K["Stirling-Tools/Stirling-PDF"] = {
    ...
    # 070 - Bill-Stewart/SyncthingWindowsSetup
    K["Bill-Stewart/SyncthingWindowsSetup"] = {
    ...
    # 071 - arthurspk/guiadofrontend
    K["arthurspk/guiadofrontend"] = {
    ...
    # 072 - fadidevv/keyhunter
    K["fadidevv/keyhunter"] = {
    ...
    # 073 - trufflesecurity/trufflehog
    K["trufflesecurity/trufflehog"] = {
    ...
    # 074 - langchain-ai/langgraph
    K["langchain-ai/langgraph"] = {
    ...
    # 077 - FalkorDB/code-graph
    K["FalkorDB/code-graph"] = {
    ...
    # 078 - open-webui/open-webui
    K["open-webui/open-webui"] = {
    ...
    # 079 - petergyang/no-ai-slop
    K["petergyang/no-ai-slop"] = {
    ...
    # 080 - opendataloader-project/opendataloader-pdf
    K["opendataloader-project/opendataloader-pdf"] = {
    ...
    # 081 - microsoft/data-formulator
    K["microsoft/data-formulator"] = {
    ...
    # 084 - Kritt-ai/open-kritt
    K["Kritt-ai/open-kritt"] = {
    ...
    # 085 - opensandbox-group/OpenSandbox
    K["opensandbox-group/OpenSandbox"] = {
    ...
    # 086 - jamiepine/voicebox
    K["jamiepine/voicebox"] = {
    ...
    # 088 - coreyhaines31/makerskills
    K["coreyhaines31/makerskills"] = {
    ...
    # 090 - google-gemini/cookbook
    K["google-gemini/cookbook"] = {
    ...
    # 091 - openai/openai-agents-python
    K["openai/openai-agents-python"] = {
    ...
    # 092 - xai-org/grok-build
    K["xai-org/grok-build"] = {
    ...
    # 093 - anthropics/claude-cookbooks
    K["anthropics/claude-cookbooks"] = {
    ...
    # 094 - FSECDEV/LEAKSFORUMS
    K["FSECDEV/LEAKSFORUMS"] = {
    ...
    # 095 - msitarzewski/agency-agents
    K["msitarzewski/agency-agents"] = {
    ...
    # 097 - trimstray/the-book-of-secret-knowledge
    K["trimstray/the-book-of-secret-knowledge"] = {
    ...
    # 099 - vinta/awesome-python
    K["vinta/awesome-python"] = {
    ...
    # 100 - jwasham/coding-interview-university
    K["jwasham/coding-interview-university"] = {
    ...
    # 101 - donnemartin/system-design-primer
    K["donnemartin/system-design-primer"] = {
    ...
    # 102 - semantica-agi/semantica
    K["semantica-agi/semantica"] = {
    ...
    # 103 - coollabsio/coolify
    K["coollabsio/coolify"] = {
    ...
    # 107 - pocketbase/pocketbase
    K["pocketbase/pocketbase"] = {
    ...
    # 108 - triggerdotdev/trigger.dev
    K["triggerdotdev/trigger.dev"] = {
    ...
    # 109 - Infisical/infisical
    K["Infisical/infisical"] = {
    ...
    # 111 - CodebuffAI/freebuff
    K["CodebuffAI/freebuff"] = {
    ...
    # 112 - deepseek-ai/deepseek-harness
    K["deepseek-ai/deepseek-harness"] = {
    ...
    # 113 - Egonex-AI/Understand-Anything
    K["Egonex-AI/Understand-Anything"] = {
    ...
    # 115 - elder-plinius/OBLITERATUS
    K["elder-plinius/OBLITERATUS"] = {
    ...
    # 116 - PaddlePaddle/PaddleOCR
    K["PaddlePaddle/PaddleOCR"] = {
    ...
    # 117 - google-research/timesfm
    K["google-research/timesfm"] = {
    ...
    # 119 - multica-ai/multica
    K["multica-ai/multica"] = {
    ...
    # 120 - xoreaxeaxeax/skitter-creek-bath-salts
    K["xoreaxeaxeax/skitter-creek-bath-salts"] = {
    ...
    # 121 - JailbrokenAI/wallbreaker
    K["JailbrokenAI/wallbreaker"] = {
    ...
    # 122 - firecrawl/pdf-inspector
    K["firecrawl/pdf-inspector"] = {
    ...
    # 123 - lllyasviel/Fooocus
    K["lllyasviel/Fooocus"] = {
    ...
    # 124 - OpenHands/OpenHands
    K["OpenHands/OpenHands"] = {
    ...
    # 128 - different-ai/openwork
    K["different-ai/openwork"] = {
    ...
    # 129 - NousResearch/hermes-agent
    K["NousResearch/hermes-agent"] = {
    ...
    # 130 - nexu-io/open-design
    K["nexu-io/open-design"] = {
    ...
    # 131 - guillaumemeyer/watermarks-remover
    K["guillaumemeyer/watermarks-remover"] = {
    ...
    # 133 - harry0703/MoneyPrinterTurbo
    K["harry0703/MoneyPrinterTurbo"] = {
    ...
    # 134 - santifer/career-ops
    K["santifer/career-ops"] = {
    ...
    # 135 - JCodesMore/ai-website-cloner-template
    K["JCodesMore/ai-website-cloner-template"] = {
    ...
    # 139 - acruz6421-bot/chatgptproxy
    K["acruz6421-bot/chatgptproxy"] = {
    ...
    # 140 - acruz6421-bot/CursorProxyFleet
    K["acruz6421-bot/CursorProxyFleet"] = {
    ...
    # 141 - melgarafael/DeskcommCRM
    K["melgarafael/DeskcommCRM"] = {
    ...
    # 142 - img2threejs/img2threejs
    K["img2threejs/img2threejs"] = {
    ...
    # 143 - x1xhlol/system-prompts-and-models-of-ai-tools
    K["x1xhlol/system-prompts-and-models-of-ai-tools"] = {
    ...
    # 144 - Graphify-Labs/graphify
    K["Graphify-Labs/graphify"] = {
    ...
    # 145 - DietrichGebert/ponytail
    K["DietrichGebert/ponytail"] = {
    ...
    # 146 - VoltAgent/awesome-agent-skills
    K["VoltAgent/awesome-agent-skills"] = {
    ...
    # 147 - Tracer-Cloud/opensre
    K["Tracer-Cloud/opensre"] = {
    ...
    # 148 - AndrewKochulab/jarvis-dashboard
    K["AndrewKochulab/jarvis-dashboard"] = {
    ...
    # 149 - mlabonne/llm-course
    K["mlabonne/llm-course"] = {
    ...
    # 150 - ObservedObserver/ChatGPT-Jailbreak-Prompts
    K["ObservedObserver/ChatGPT-Jailbreak-Prompts"] = {
    ...
    # 151 - hacker-gpt/cybergym
    K["hacker-gpt/cybergym"] = {
    ...
    # 152 - PDFMathTranslate/PDFMathTranslate
    K["PDFMathTranslate/PDFMathTranslate"] = {
    ...
    # 155 - DannyMac180/sol-advisor
    K["DannyMac180/sol-advisor"] = {
    ...
    # 157 - zhaoxuya520/reverse-skill
    K["zhaoxuya520/reverse-skill"] = {
    ...
    # 161 - oso95/scroll-world
    K["oso95/scroll-world"] = {
    ...
    # 162 - jujumilk3/leaked-system-prompts
    K["jujumilk3/leaked-system-prompts"] = {
    ...
    # 163 - Shubhamsaboo/awesome-llm-apps
    K["Shubhamsaboo/awesome-llm-apps"] = {
    ...
    # 164 - punkpeye/awesome-mcp-servers
    K["punkpeye/awesome-mcp-servers"] = {
    ...
    # 166 - awesome-selfhosted/awesome-selfhosted
    K["awesome-selfhosted/awesome-selfhosted"] = {
    ...
    # 167 - public-apis/public-apis
    K["public-apis/public-apis"] = {
    ...
    # 168 - ripienaar/free-for-dev
    K["ripienaar/free-for-dev"] = {
    ...
    # 169 - sindresorhus/awesome
    K["sindresorhus/awesome"] = {
    ...
    # 170 - JuliusBrussee/caveman
    K["JuliusBrussee/caveman"] = {
    ...
    # 171 - odysseus-dev/odysseus
    K["odysseus-dev/odysseus"] = {
    ...
    # 172 - thekingsgaming67-sudo/Claude-AI-Max-Pro-Version-26
    K["thekingsgaming67-sudo/Claude-AI-Max-Pro-Version-26"] = {
    ...
    # 173 - rubenmarcus/malicious-repositories
    K["rubenmarcus/malicious-repositories"] = {
    ...
    # 175 - diegosouzapw/OmniRoute
    K["diegosouzapw/OmniRoute"] = {
    ...
    # 176 - AchoArnold/discount-for-student-dev
    K["AchoArnold/discount-for-student-dev"] = {
    ...
    # 177 - ShreyamMaity/student-offers
    K["ShreyamMaity/student-offers"] = {
    ...
    # 178 - mn-api/awesome-ai-proxy
    K["mn-api/awesome-ai-proxy"] = {
    ...
    # 181 - andreasbm/web-skills
    K["andreasbm/web-skills"] = {
    ...
    # 182 - remoteintech/remote-jobs
    K["remoteintech/remote-jobs"] = {
    ...
    # 183 - hideraldoluis/roadmap-do-desenvolvedor-web
    K["hideraldoluis/roadmap-do-desenvolvedor-web"] = {
    ...
    # 184 - iuricode/padroes-de-commits
    K["iuricode/padroes-de-commits"] = {
    ...
    # 186 - arthurspk/guiadevbrasil
    K["arthurspk/guiadevbrasil"] = {
    ...
    # 188 - dennisdelima18pe/Nubank-redesign
    K["dennisdelima18pe/Nubank-redesign"] = {
    ...
    # 189 - chrislgarry/Apollo-11
    K["chrislgarry/Apollo-11"] = {
    ...
    # 190 - cppbrasil/material-de-aprendizado
    K["cppbrasil/material-de-aprendizado"] = {
    ...
    # 191 - sujeeth36/TradingView-Premium-FREE (caso reapareça no futuro, tratado de forma limpa)
    K["sujeeth36/TradingView-Premium-FREE"] = {
    ...
    print(f"Total repositórios em all_stars: {len(stars)}")
    print(f"Total cobertos na base de conhecimento: {covered}")
    if missing:
...
if __name__ == '__main__':
    kb = build_all_191_entries()
    output_file = os.path.join(BASE_DIR, "scripts", "knowledge_catalog.py")
    with open(output_file, "w", encoding="utf-8") as f:
        f.write("# -*- coding: utf-8 -*-\n")
        f.write('"""Catálogo de Conhecimento Especializado 100% PT-BR para todos os 191 repositórios."""\n\n')
        f.write("REPO_KNOWLEDGE_BASE = ")
        json.dump(kb, f, indent=2, ensure_ascii=False)
        f.write("\n")
    print(f"Base de conhecimento 100% individualizada gerada com sucesso para todos os {len(kb)} repositórios em scripts/knowledge_catalog.py!")
